...
export const DashboardDeleteButton =  ({getDelete}) => {
 
  return (
    <button onClick={getDelete} className="py-1 px-2 bg-[#045544] outline-[#045544] rounded shadow-md transition-all hover:-translate-y-[1px] hover:bg-[#1d6657] hover:shadow-lg">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
